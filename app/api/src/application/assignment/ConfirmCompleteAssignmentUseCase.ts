...
import { assertCanConfirmComplete } from "../../domain/assignment/AssignmentLifecycle";
...
export class ConfirmCompleteAssignmentUseCase {
  constructor(
  ...
  execute(id: string): Assignment {
    return this.db.transaction(() => {
      ...
      assertCanConfirmComplete(existing, now);
